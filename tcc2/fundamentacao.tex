...
\begin{figure}[!htb]
	\centering
		...
		\includegraphics[scale=0.7]{sensorVelocidadeEx} 
...
\begin{figure}[!htb]
	...
	\qquad
	\subfigure[Fonte:\cite{Fraden2016}][Exemplo do funcionamento. Fonte:\cite{Fraden2016} modificada pelo autor, 2018]{\includegraphics[width=5cm]{sensorCvtfunc}\label{fig:sensorCvtfunc}}
	\label{fig:sensorCvt}
\end{figure}
